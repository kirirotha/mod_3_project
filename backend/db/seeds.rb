...
jarz = Minion.create(name: 'Jarz', src: "images/Fighter_3.png",scalarH: 1,  leader: false, class_type: 1, cell: "7_16", hp: 50, hp_max: 50, atk: 12, atk_range: 1, move_range: 4, player_id: p2.id, player1or2: 2, active: true)
#teek = Minion.create(name: 'Teek', leader: false, class_type: 1, hp: 65, atk: 9, atk_range: 1, move_range: 4)
mae = Minion.create(name: 'Mae', src: "images/Fighter_4_W.png",scalarH: 0.8,  leader: false, class_type: 1, cell: "7_1", hp: 55, hp_max: 55, atk: 10, atk_range: 1, move_range: 4, player_id: p1.id, player1or2: 1, active: true)

# Archer Class
ghost = Minion.create(name: 'Ghost', leader: false, src: "images/Archer_1.png",scalarH: 0.8,  class_type: 2, cell: "8_16", hp: 65, hp_max: 65, atk: 9, atk_range: 3, move_range: 3, player_id: p2.id, player1or2: 2, active: true)
yinzo = Minion.create(name: 'Yinzo', src: "images/Archer_2_W.png",scalarH: 0.8,  leader: false, class_type: 2, cell: "8_1", hp: 45, hp_max: 45, atk: 12, atk_range: 3, move_range: 3, player_id: p1.id, player1or2: 1, active: true)
...
claudette = Minion.create(name: 'Claudette', src: "images/Mage_2.png",scalarH: 0.8,  leader: false, class_type: 3, cell: "9_16", hp: 50, hp_max: 50, atk: 15, atk_range: 2, move_range: 3, player_id: p2.id, player1or2: 2, active: true)
gyler = Minion.create(name: 'Gyler', src: "images/Mage_1.png",scalarH: 1,  leader: false, class_type: 3, cell: "9_1", hp: 45, hp_max: 45, atk: 17, atk_range: 2, move_range: 3, player_id: p1.id, player1or2: 1, active: true)
#lynette = Minion.create(name: 'Lynette', leader: false, class_type: 3, hp: 40, atk: 18, atk_range: 2, move_range: 3)

# Leader Fighter Class
leader_fighter = Minion.create(name: 'Mary', src: "images/Leader_Fighter.png",scalarH: 0.8,  leader: true, class_type: 4, cell: "10_16", hp: 145, hp_max: 145, atk: 13, atk_range: 1, move_range: 5, player_id: p2.id, player1or2: 2, active: true)

# Leader Archer Class
leader_archer = Minion.create(name: 'Bob', src: "images/Leader_Archer.png",scalarH: 0.8,  leader: true, class_type: 5, cell: "10_1", hp: 125, hp_max: 125, atk: 12, atk_range: 3, move_range: 5, player_id: p1.id, player1or2: 1, active: true)
